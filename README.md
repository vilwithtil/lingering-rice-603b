...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-rice-603b
```

A live public deployment of this template is available at [https://lingering-rice-603b.templates.workers.dev](https://lingering-rice-603b.templates.workers.dev)
